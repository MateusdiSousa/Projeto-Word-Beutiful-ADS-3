    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <div className="row">
                    <Link to={'/clientes'} className="btn-floating btn-small waves-effect waves-light transparent">
                    ...
                    <form action="">
                        ...
                        <div className="row">
                            <button className="btn waves-effect waves-light yellow lighten-1" type="submit" name="action">
                                Cadastrar
